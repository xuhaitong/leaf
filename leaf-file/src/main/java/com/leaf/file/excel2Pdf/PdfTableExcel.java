...
public class PdfTableExcel {
    ...
    public List<PdfPTable> getTable() throws BadElementException, MalformedURLException, IOException {
        ...
        return toParseContent(sheetList);
    }

    private List<PdfPTable> toParseContent(List<Sheet> sheetList) throws BadElementException, MalformedURLException, IOException {
...
//        Sheet sheet = excel.getSheetList();
...
//        Sheet sheet = excel.getSheetList();
    ...
    protected int getVAlignByExcel(Enum align) {
        int result = 0;
        if (align == VerticalAlignment.BOTTOM || align == org.apache.poi.ss.usermodel.VerticalAlignment.BOTTOM) {
            result = Element.ALIGN_BOTTOM;
        }
        if (align == VerticalAlignment.MIDDLE || align == org.apache.poi.ss.usermodel.VerticalAlignment.CENTER) {
            result = Element.ALIGN_MIDDLE;
        }
        if (align == VerticalAlignment.JUSTIFIED || align == org.apache.poi.ss.usermodel.VerticalAlignment.JUSTIFY) {
            result = Element.ALIGN_JUSTIFIED;
        }
        if (align == VerticalAlignment.TOP || align == org.apache.poi.ss.usermodel.VerticalAlignment.TOP) {
            result = Element.ALIGN_TOP;
        }
        return result;
    }

    protected int getHAlignByExcel(Enum align) {
        int result = 0;
