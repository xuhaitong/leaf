...
public class StringUtils extends org.apache.commons.lang3.StringUtils {
    ...
    * @throws
    ...
    /**
     * 如果不为空，则设置值
    * @Title: setValueIfNotBlank
    * @Description: TODO
    * @param @param target
    * @param @param source    参数
    * @return void    返回类型
    * @throws
     */
	...
	* @throws
	 ...
	 * @return
	 */
	public static String getVerCode(int max, int min){
		String code = String.valueOf((int)(Math.random()*(max-min+1)+min));
		return code;
	}
	
	public static String getVerCode(){
		return getVerCode(999999, 100000);
	}
